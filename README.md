...
WinterVoice is a native macOS dictation app with a primary window, menu-bar utility, and non-activating recording overlay. It supports private on-device transcription through whisper.cpp as well as a generic OpenAI-compatible remote transcription endpoint.
